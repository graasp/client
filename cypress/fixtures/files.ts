...
export const IMAGE_ITEM_DEFAULT: LocalFileItemType & { readFilepath: string } =
  {
...
export const VIDEO_ITEM_DEFAULT: LocalFileItemType & { readFilepath: string } =
  {
...
export const PDF_ITEM_DEFAULT: LocalFileItemType & { readFilepath: string } = {
...
export const IMAGE_ITEM_S3 = PackedS3FileItemFactory(
  {
...
export const VIDEO_ITEM_S3 = PackedS3FileItemFactory(
  {
...
export const PDF_ITEM_S3 = PackedS3FileItemFactory(
  {
    id: 'bd5519a2-5ba9-4305-b221-185facbe6a99',
    name: 'doc.pdf',
    description: 'a default pdf description',
