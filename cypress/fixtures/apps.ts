import { AppItemFactory, PackedAppItemFactory } from '@graasp/sdk';
...
export const GRAASP_APP_ITEM = AppItemFactory({
...
export const APP_USING_CONTEXT_ITEM = PackedAppItemFactory(
  {
    id: 'ecafbd2a-5688-12eb-ae91-0272ac130002',
...
export const PUBLIC_APP_USING_CONTEXT_ITEM = {
