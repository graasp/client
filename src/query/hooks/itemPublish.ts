  ...
  return {
    useAllPublishedItems: (
      ...
      return useQuery({
        ...
        queryFn: () => Api.getAllPublishedItems(args ?? {}),
        ...defaultQueryOptions,
    ...
    useMostLikedPublishedItems: (
      ...
      return useQuery({
        ...
        queryFn: () => Api.getMostLikedPublishedItems(args ?? {}),
        ...defaultQueryOptions,
        enabled: enabledValue,
      });
    },
    useMostRecentPublishedItems: (
      ...
      return useQuery({
        ...
        queryFn: () => Api.getMostRecentPublishedItems(args ?? {}),
        ...defaultQueryOptions,
        enabled: enabledValue,
      });
    },
    usePublishedItemsForMember: (
      ...
      useQuery({
        ...
        queryFn: () => {
          ...
          return Api.getPublishedItemsForMember(memberId);
        },
        ...defaultQueryOptions,
    ...
    useItemPublishedInformation: (
      ...
      return useQuery({
        ...
        queryFn: () => {
          ...
          return Api.getItemPublishedInformation(itemId);
        },
        ...defaultQueryOptions,
        enabled: enabledValue,
      });
