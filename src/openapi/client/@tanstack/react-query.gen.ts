...
export const downloadFileMutation = (options?: Partial<Options<DownloadFileData>>): UseMutationOptions<DownloadFileResponse, DownloadFileError, Options<DownloadFileData>> => {
    const mutationOptions: UseMutationOptions<DownloadFileResponse, DownloadFileError, Options<DownloadFileData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await downloadFile({
                ...options,
                ...localOptions,
