...
export const requestPasswordResetLinkQueryKey = (options: Options<RequestPasswordResetLinkData>) => createQueryKey('requestPasswordResetLink', options);
 ...
 */
export const requestPasswordResetLinkOptions = (options: Options<RequestPasswordResetLinkData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
