...
export const signInWithPasswordQueryKey = (options: Options<SignInWithPasswordData>) => createQueryKey('signInWithPassword', options);
 ...
 */
export const signInWithPasswordOptions = (options: Options<SignInWithPasswordData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const createPasswordQueryKey = (options: Options<CreatePasswordData>) => createQueryKey('createPassword', options);
...
export const requestResetPasswordLinkQueryKey = (options: Options<RequestResetPasswordLinkData>) => createQueryKey('requestResetPasswordLink', options);
 ...
 */
export const requestResetPasswordLinkOptions = (options: Options<RequestResetPasswordLinkData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await requestResetPasswordLink({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: requestResetPasswordLinkQueryKey(options)
    });
};
 ...
 * Create a reset password request. This will send an email to the member in his language with a link to reset the password. The link will be valid for a limited time.
 */
export const requestResetPasswordLinkMutation = (options?: Partial<Options<RequestResetPasswordLinkData>>): UseMutationOptions<unknown, DefaultError, Options<RequestResetPasswordLinkData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<RequestResetPasswordLinkData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await requestResetPasswordLink({
                ...options,
                ...localOptions,
