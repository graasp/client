 ...
 */
export const requestResetPasswordLink = <ThrowOnError extends boolean = false>(options: Options<RequestResetPasswordLinkData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RequestResetPasswordLinkResponses, RequestResetPasswordLinkErrors, ThrowOnError>({
        url: '/password/reset',
        ...options,
        headers: {
            'Content-Type': 'application/json',
