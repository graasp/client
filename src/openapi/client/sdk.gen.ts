...
export const convertFolderToCapsule = <ThrowOnError extends boolean = false>(options: Options<ConvertFolderToCapsuleData, ThrowOnError>) => {
    return (options.client ?? client).patch<ConvertFolderToCapsuleResponses, ConvertFolderToCapsuleErrors, ThrowOnError>({
...
export const convertCapsuleToFolder = <ThrowOnError extends boolean = false>(options: Options<ConvertCapsuleToFolderData, ThrowOnError>) => {
    return (options.client ?? client).patch<ConvertCapsuleToFolderResponses, ConvertCapsuleToFolderErrors, ThrowOnError>({
