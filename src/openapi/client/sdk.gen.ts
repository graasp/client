...
export const signOut = <ThrowOnError extends boolean = false>(options?: Options<SignOutData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SignOutResponses, SignOutErrors, ThrowOnError>({
        url: '/logout',
        ...options
    });
};
...
export const signInWithPassword = <ThrowOnError extends boolean = false>(options: Options<SignInWithPasswordData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SignInWithPasswordResponses, SignInWithPasswordErrors, ThrowOnError>({
        url: '/login-password',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const updatePassword = <ThrowOnError extends boolean = false>(options: Options<UpdatePasswordData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdatePasswordResponses, UpdatePasswordErrors, ThrowOnError>({
        url: '/password',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const createPassword = <ThrowOnError extends boolean = false>(options: Options<CreatePasswordData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreatePasswordResponses, CreatePasswordErrors, ThrowOnError>({
        url: '/password',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const requestPasswordResetLink = <ThrowOnError extends boolean = false>(options: Options<RequestPasswordResetLinkData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RequestPasswordResetLinkResponses, RequestPasswordResetLinkErrors, ThrowOnError>({
        url: '/password/reset',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getOwnPasswordStatus = <ThrowOnError extends boolean = false>(options?: Options<GetOwnPasswordStatusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetOwnPasswordStatusResponses, unknown, ThrowOnError>({
...
export const createPage = <ThrowOnError extends boolean = false>(options: Options<CreatePageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreatePageResponses, CreatePageErrors, ThrowOnError>({
        url: '/items/pages',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const pagesWebsockets = <ThrowOnError extends boolean = false>(options: Options<PagesWebsocketsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PagesWebsocketsResponses, unknown, ThrowOnError>({
...
export const pagesWebsockets2 = <ThrowOnError extends boolean = false>(options: Options<PagesWebsockets2Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PagesWebsockets2Responses, unknown, ThrowOnError>({
